...
- (BOOL)drawFrameWithTexture:(GLuint)texture rotate:(int)rotate
{
...
//- (BOOL)drawFrameWithTexture:(GLuint)texture mask:(GLuint)maskTexture rotate:(int)rotate {
//    static const GLfloat squareVertices[] = {
//        -1.0f, -1.0f,
//        1.0f, -1.0f,
//        -1.0f,  1.0f,
...
- (EffectsGLShader *)glShader{
    if (!_glShader) {
        ...
        const NSString* vertexShaderSource = TTF_SHADER_STRING
        (
        ...
        const NSString* fragmentShaderSource = TTF_SHADER_STRING
        (
        ...
        _glShader = [[EffectsGLShader alloc] initWithVertexShader:vertexShaderSource
